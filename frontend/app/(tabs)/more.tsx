...
function HaccpPage({ goBack, state, addHaccpPhoto }: any) {
  ...
  // Charge les frigos au démarrage
  useEffect(() => {
    loadFridges();
  }, []);
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
        ...
        <Text style={{ color: '#9A8060', fontSize: 12, marginBottom: 12, lineHeight: 18 }}>
          Configure ici tes frigos et congélateurs. Ils apparaîtront comme choix lors de chaque scan.
        </Text>
                ...
                <View style={{ flexDirection: 'row', gap: 10 }}>
                  <TouchableOpacity
                    style={{
                      ...
                      backgroundColor: newFridgeType === 'positif' ? '#D4AF37' : '#1a1a1a',
                      borderWidth: 1, borderColor: '#D4AF37',
                    }}
                    onPress={() => setNewFridgeType('positif')}
                  >
                    <Text style={{ fontSize: 20 }}>❄️</Text>
                    <Text style={{ color: newFridgeType === 'positif' ? '#000' : '#D4AF37', fontSize: 11, marginTop: 4, fontWeight: 'bold' }}>
                      RÉFRIGÉRATEUR
                    </Text>
                    <Text style={{ color: newFridgeType === 'positif' ? '#333' : '#666', fontSize: 10 }}>
                      0°C à 8°C
                    </Text>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity
                    style={{
                      flex: 1, padding: 12, borderRadius: 8, alignItems: 'center',
                      backgroundColor: newFridgeType === 'negatif' ? '#D4AF37' : '#1a1a1a',
                      borderWidth: 1, borderColor: '#D4AF37',
                    }}
                    onPress={() => setNewFridgeType('negatif')}
                  >
                    <Text style={{ fontSize: 20 }}>🧊</Text>
                    <Text style={{ color: newFridgeType === 'negatif' ? '#000' : '#D4AF37', fontSize: 11, marginTop: 4, fontWeight: 'bold' }}>
                      CONGÉLATEUR
                    </Text>
                    <Text style={{ color: newFridgeType === 'negatif' ? '#333' : '#666', fontSize: 10 }}>
                      -15°C à -25°C
                    </Text>
                  </TouchableOpacity>
                </View>
        ...
        {/* ─── SECTION : ÉTIQUETTES SANITAIRES (ton code existant) ─── */}
